...
@section('content')
    ...
    <div class="container col-10">
        <div class="row">
            <div class="card normal analysis " style="width: 18rem;display:none">
            ...
            <div class="card normal clustering" style="width: 18rem;display:none">
            ...
            <div class="card normal" style="width: 18rem;display:none">
            ...
            <div class="card normal quantitative" style="width: 18rem;display:none">
    ...
    <script>
        ['normal','clustering','analysis','quantitative'].forEach(
            item=>{
                if('{{$cate}}' === item){
                    $('.'.concat(item)).attr('style','display:block;width:30%')
                }
            }
        )
    </script>
